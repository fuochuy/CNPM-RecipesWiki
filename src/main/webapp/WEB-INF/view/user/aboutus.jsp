...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fouder" id="fouder">
      <div class="topic-container">
        <div class="row">
          <div class="col-md-3">
            <img class="pic-menu" src="./Image/aboutus/Duc.png" alt="" />
          </div>
          <div class="col-md-9">
            <div class="text">
              <h3>Youngboi Bình Phước</h3>
              <p>
                Họ và tên: Đàm Hồng Đức <br />
                MSSV: 19120481
              </p>
            </div>
          </div>
      ...
      <div class="topic-container">
        <div class="row">
          <div class="col-md-3">
            <img class="pic-menu" src="./Image/aboutus/Minh.png" alt="" />
          </div>
          <div class="col-md-9">
            <div class="text">
              <h3>Youngboi Lâm Đồng</h3>
              <p>Họ và tên: Lê Thái Bình Minh <br />MSSV: 19120583</p>
            </div>
          </div>
        </div>
      </div>
      <div class="topic-container">
        <div class="row">
          <div class="col-md-3">
            <img class="pic-menu" src="./Image/aboutus/Huy.png" alt="" />
          </div>
          <div class="col-md-9">
            <div class="text">
              <h3>Youngboi Quảng Nam</h3>
              <p>Họ và tên: Nguyễn Phước Huy <br />MSSV: 19120529</p>
            </div>
          </div>
        </div>
      </div>
